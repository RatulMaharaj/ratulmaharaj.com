...
Save the yaml above as `nightwind.yaml` in your `~/.config/warp/themes` directory. Be sure to also check out the matching [Nightwind](https://marketplace.visualstudio.com/items?itemName=RatulMaharaj.nightwind) VS Code theme!
